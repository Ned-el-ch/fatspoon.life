		...
		<div className="content hp-container">
			...
			<div className="content--inner">
				...
				<div className="hp-app-get-started-container">
					<span className="hp-app-get-started">Add some ingredients to <Link to="/MyFridge">My Fridge</Link> or maybe add a recipe to <Link to="/Cookbook">My Cookbook</Link>!</span>
				</div>
				:
				<div className="hp-app-get-started-container">
